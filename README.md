...
testinguiwebautomation/
├── src/
│   ├── main/java/testinguiwebautomation/pages/      # Page Objects
│   └── test/
│       ├── java/testinguiwebautomation/
│       │   ├── stepDefinitions/                     # Logika Gherkin
│       │   ├── hooks/                                # Setup & Teardown
│       │   └── runner/                               # Runner TestNG
│       └── resources/
